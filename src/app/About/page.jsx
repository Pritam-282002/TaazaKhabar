...
function page() {
  return (
    <div className="min-h-screen"><section className="bg-white">
    <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
        <div className="max-w-lg">
          ...
          <div className="mt-8">
            <a href="https://www.instagram.com/impri_tam28/" target='_blank' className="text-pink-500 hover:text-pink-600 font-medium">
              Learn more about us
